...
Original file is located at
    https://colab.research.google.com/drive/14yqRhZXGayF8Z8UVIPP9YrYoxggSKBd0
"""
...
dt = DecisionTreeRegressor(random_state=150)
...
estimators =[('xgb',xgb_model),('dtree',dt)]
#estimators =[('xgb',xgb_model),('rf',rf_model),('dtree',dt)]

stack_reg = StackingRegressor(estimators=estimators, final_estimator=rf_model)
...
# assuming you have imported the necessary libraries and created the 'results_df' DataFrame

# define the name of the Excel file you want to create
excel_file_name = 'my_results2.xlsx'
...
results_df.to_excel(excel_writer, sheet_name='Sheet1')
